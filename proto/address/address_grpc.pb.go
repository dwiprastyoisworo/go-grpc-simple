...
type AddressServiceClient interface {
	GetAddressByUserID(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressResponse, error)
}
...
func (c *addressServiceClient) GetAddressByUserID(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
	out := new(AddressResponse)
	err := c.cc.Invoke(ctx, "/address.AddressService/GetAddressByUserID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressServiceServer interface {
	GetAddressByUserID(context.Context, *AddressRequest) (*AddressResponse, error)
...
func (UnimplementedAddressServiceServer) GetAddressByUserID(context.Context, *AddressRequest) (*AddressResponse, error) {
...
func _AddressService_GetAddressByUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressServiceServer).GetAddressByUserID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/address.AddressService/GetAddressByUserID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressServiceServer).GetAddressByUserID(ctx, req.(*AddressRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AddressService_GetAddressByUserID_Handler,
		},
	},
